...
// #define  ocb_buf_size 80 //4 // Mohsen
#define  OCB_TAG_NONCE 22 // 28
extern char ocb_pt[8*1024];
extern char ocb_tag[16];
extern unsigned char ocb_key[30];
// extern unsigned char ocb_nonce[16];
extern unsigned char gcm_nonce[16];
extern int ocb_len;
extern int ocb_iter_list[2048]; /* Populate w/ test lengths, -1 terminated */
// extern unsigned char ocb_ciphertext_sendbuf[ocb_buf_size*4*1024*1024+16+16];
// extern unsigned char ocb_ciphertext_recvbuf[ocb_buf_size*4*1024*1024+16+16]; // 128 * 128 * 1024

// extern unsigned char ocb_ciphertext_sendbuf[1024*1024+16+16];
...
/* Define sizes */
#define gcm_buf_size 128
#define COMMON_LARGE_SEND_BUFFER_SIZE  gcm_buf_size*1048604 //67130656 //67,130,656 //150401232 //9437184 
#define COMMON_LARGE_RECV_BUFFER_SIZE  gcm_buf_size*1048604 //67130656 //67108864 //150401232 //9437184 
#define NON_BLOCKING_SND_RCV_1 64 // 2 //64 mohsen
#define NON_BLOCKING_SND_RCV_2 4194424 //1048604 // 9437184 // 2 // mohsen
...
/* Externs */
extern ae_ctx *ocb_ctx,*ocb_enc_ctx,*ocb_dec_ctx,*ocb_enc_ctx2,*ocb_dec_ctx2,*ocb_enc_ctx3,*ocb_dec_ctx3,*ocb_enc_ctx4,*ocb_dec_ctx4;
