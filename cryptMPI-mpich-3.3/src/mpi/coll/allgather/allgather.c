                              ...
                              MPI_Datatype recvtype, MPIR_Comm * comm_ptr, MPIR_Errflag_t * errflag)
{
   ...
   if (PRINT_FUN_NAME || DEBUG_INIT_FILE){
		...
		printf("[allreduce rank = %d host = %s count = %d SEC_AP=%d] Func: MPIR_Allgather_intra_auto\n", comm_ptr->rank,hostname,recvcount,security_approach);fflush(stdout);
	}
#endif  	
    int comm_size;
                        ...
                        MPIR_Comm * comm_ptr, MPIR_Errflag_t * errflag)
{
   ...
   if (PRINT_FUN_NAME || DEBUG_INIT_FILE){
		char hostname[100];
		gethostname(hostname, MAX_HOSTNAME_LEN);
		printf("[Allgather rank = %d host = %s count = %d  Intra-comm = %d  ALLG_METHOD = %d] Func: MPIR_Allgather_impl\n", comm_ptr->rank,hostname,recvcount,comm_ptr->comm_kind == MPIR_COMM_KIND__INTRACOMM,mv2_user_allgather_inter);fflush(stdout);
	}
#endif  	
    int mpi_errno = MPI_SUCCESS;


    if (init_phase==0 && mv2_user_allgather_inter>0){
        switch (mv2_user_allgather_inter) {
            case 1:
                mpi_errno =
                    MPIR_Naive_Sec_Allgather(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm_ptr, errflag);
                break;
            case 2:
                mpi_errno =
                    MPIR_OCB_Naive_Sec_Allgather(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm_ptr, errflag);
                break;
            case 3:
                mpi_errno =
                    MPIR_OCB_unrol2_Naive_Sec_Allgather(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm_ptr, errflag);
                break;
            case 4:
                mpi_errno =
                    MPIR_OCB_unrol4_Naive_Sec_Allgather(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm_ptr, errflag);
                break;
            case 8:
                mpi_errno =
                    MPIR_Allgather_Bruck_SEC(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm_ptr, errflag);
                break;
            case 9:
                mpi_errno =
                    MPIR_Allgather_Ring_SEC(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm_ptr, errflag);
                break;
            case 10:
                mpi_errno =
                    MPIR_Allgather_RD_MV2(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm_ptr, errflag);
                break;
            case 12:
                mpi_errno =
                    MPIR_2lvl_Allgather_Multileader_RD(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm_ptr, errflag);
                break;
            case 13:
                mpi_errno =
                    MPIR_2lvl_Allgather_Multileader_Ring(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm_ptr, errflag);
                break;
            case 14:
                mpi_errno =
                    MPIR_2lvl_SharedMem_Allgather_MV2(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm_ptr, errflag);  // export SHMEM_LEADERS
                break;
            case 16:
                mpi_errno =
                    MPIR_Allgather_NaivePlus_RDB_MV2(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm_ptr, errflag);
                break;
            case 18:
                mpi_errno =
                    MPIR_2lvl_SharedMem_Concurrent_Encryption_Allgather(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm_ptr, errflag); // Single-leaders
                break;
            case 20:
                mpi_errno =
                    MPIR_Allgather_2lvl_Concurrent_Multileader_SharedMem(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm_ptr, errflag); // Multi-leaders
                break;
            case 21:
                mpi_errno =
                    MPIR_2lvl_Allgather_MV2(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm_ptr, errflag);
                break;
            case 22:
                mpi_errno =
                    MPIR_2lvl_Allgather_nonblocked_MV2(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm_ptr, errflag);
                break;
            default:
                mpi_errno =
                    MPIR_Allgather_NaivePlus_RDB_MV2(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm_ptr, errflag);
    ...
    /*
    if ( (security_approach>2004 || security_approach<2008)){
        if (security_approach==2005){
            if (ALLGATHER_METHOD==1)
				return (sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm_ptr, errflag);
			else if (ALLGATHER_METHOD==2)
				return (sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm_ptr, errflag);
			else if (ALLGATHER_METHOD==3)
				return (sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm_ptr, errflag);			
            else if (ALLGATHER_METHOD==4)
				return (sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm_ptr, errflag);
            else return (sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm_ptr, errflag);
        } else if (security_approach==2006){
            return (sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm_ptr, errflag);    // export MV2_SHMEM_LEADERS
            return (sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm_ptr, errflag);           
             return (sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm_ptr, errflag);
        } else if (security_approach==2007){
            return (sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm_ptr, errflag);            
            return (sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm_ptr, errflag);            
        }
    } */
                   ...
                   MPIR_Comm * comm_ptr, MPIR_Errflag_t * errflag)
{
   ...
   if (PRINT_FUN_NAME || DEBUG_INIT_FILE){
		char hostname[100];
		gethostname(hostname, MAX_HOSTNAME_LEN);
		printf("[Allgather rank = %d host = %s count = %d] Func: MPIR_Allgather\n", comm_ptr->rank,hostname,recvcount);fflush(stdout);
	}
#endif 	
    int mpi_errno = MPI_SUCCESS;
                  ...
                  void *recvbuf, int recvcount, MPI_Datatype recvtype, MPI_Comm comm)
{
   ...
   if (PRINT_FUN_NAME || DEBUG_INIT_FILE){
		char hostname[100];
		gethostname(hostname, MAX_HOSTNAME_LEN);
		printf("[Allgather rank = %d host = %s count = %d] Func: MPI_Allgather\n", comm_ptr->rank,hostname,recvcount);fflush(stdout);
	}
#endif  	
    int mpi_errno = MPI_SUCCESS;
