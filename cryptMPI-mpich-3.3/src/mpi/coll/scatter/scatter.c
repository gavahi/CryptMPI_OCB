                      ...
                      MPIR_Errflag_t * errflag)
{
   ...
   if (PRINT_FUN_NAME || DEBUG_INIT_FILE){
		...
		printf("[Scatter rank = %d host = %s count = %d SA=%d] Func: MPIR_Scatter_impl\n", comm_ptr->rank,hostname,recvcount,security_approach);fflush(stdout);
	}
#endif 
    int mpi_errno = MPI_SUCCESS;

    
    /*if (security_approach==200 && init_phase == 0){
        
        mpi_errno = MPIR_Scatter_MV2_Direct_no_shmem_intra_RR(sendbuf, sendcount, sendtype,recvbuf, recvcount, recvtype, root,comm_ptr, errflag);
        // mpi_errno = MPIR_Scatter_MV2_Direct_HBcast(sendbuf, sendcount, sendtype,recvbuf, recvcount, recvtype, root,comm_ptr, errflag);
        // mpi_errno = MPIR_Scatter_MV2_Direct_CHS(sendbuf, sendcount, sendtype,recvbuf, recvcount, recvtype, root,comm_ptr, errflag);
        // mpi_errno = MPIR_Scatter_MV2_Direct(sendbuf, sendcount, sendtype,recvbuf, recvcount, recvtype, root,comm_ptr, errflag);
    }*/
    
    if (init_phase==0 &&  security_approach==221) {
                mpi_errno =
                    MPIR_Naive_Sec_Scatter(sendbuf, sendcount, sendtype,recvbuf, recvcount, recvtype, root,comm_ptr, errflag);

    } else if (init_phase==0 &&  security_approach==222) {
                mpi_errno =
                    MPIR_OCB_Naive_Sec_Scatter(sendbuf, sendcount, sendtype,recvbuf, recvcount, recvtype, root,comm_ptr, errflag);

    } else if (init_phase==0 &&  security_approach==223) {
                mpi_errno =
                    MPIR_OCB_unrol2_Naive_Sec_Scatter(sendbuf, sendcount, sendtype,recvbuf, recvcount, recvtype, root,comm_ptr, errflag);

    } else if (init_phase==0 &&  security_approach==224) {
                mpi_errno =
                    MPIR_OCB_unrol4_Naive_Sec_Scatter(sendbuf, sendcount, sendtype,recvbuf, recvcount, recvtype, root,comm_ptr, errflag);

    } else if (init_phase==0 && inter_scatter_tuning>0){
        switch (inter_scatter_tuning) {
            case 6:
                mpi_errno =
                    MPIR_Scatter_MV2_Direct_CHS(sendbuf, sendcount, sendtype,recvbuf, recvcount, recvtype, root,comm_ptr, errflag);
                break;
            case 7:
                mpi_errno =
                    MPIR_Scatter_MV2_Direct_no_shmem_intra_RR(sendbuf, sendcount, sendtype,recvbuf, recvcount, recvtype, root,comm_ptr, errflag);
                break;
            case 9:
                mpi_errno =
                    MPIR_Scatter_MV2_Direct_HBcast(sendbuf, sendcount, sendtype,recvbuf, recvcount, recvtype, root,comm_ptr, errflag);
                break;
            case 10:                
                mpi_errno =
                    MPIR_Scatter_MV2_Direct_no_shmem(sendbuf, sendcount, sendtype,recvbuf, recvcount, recvtype, root,comm_ptr, errflag);
                break;    
            case 11:                
                mpi_errno =                    
                    MPIR_Scatter_MV2_two_level_Direct(sendbuf, sendcount, sendtype,recvbuf, recvcount, recvtype, root,comm_ptr, errflag);        
                break;  
            case 12:
                mpi_errno =
                    MPIR_Scatter_MV2_Direct(sendbuf, sendcount, sendtype,recvbuf, recvcount, recvtype, root,comm_ptr, errflag);
                break;          
            default:
                mpi_errno =
                    MPIR_Scatter_MV2_Direct(sendbuf, sendcount, sendtype,recvbuf, recvcount, recvtype, root,comm_ptr, errflag);
